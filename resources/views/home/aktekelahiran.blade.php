...
<head>
    ...
    <title>Desa Sumberkedawung | AKTA KELAHIRAN</title>
    <meta content="" name="description">
    <meta content="" name="keywords">

    <!-- Favicons -->
    <link href="assets/img/favicon.png" rel="icon">
    <link href="assets/img/apple-toucpngh-icon." rel="apple-touch-icon">
...
<body>
    ...
    <div class="section-title" mt-4>
        <h2>PEMBUATAN AKTA KELAHIRAN</h2>
    </div>
    <div class="container">
        <h6>DESKRIPSI</h6>
        <p>Akta Kelahiran adalah Bukti Sah mengenai Status dan Peristiwa Kelahiran Seseorang yang dikeluarkan oleh Dinas Kependudukan dan Catatan Sipil. Bayi yang dilaporkan kelahirannya akan terdaftar dalam Kartu Keluarga dan diberi Nomor Induk Kependudukan (NIK) sebagai Dasar untuk Memperoleh Pelayanan Masyarakat Lainnya. Manfaat Akta Kelahiran: </p>
        <ul>
            <li>Identitas Anak</li>
            <li>Administrasi Kependudukan</li>
            <li>Untuk Keperluan Sekolah</li>
            <li>Untuk Pendaftaran Pernikahan di KUA</li>
            <li>Persyaratan Pembuatan Paspor</li>
            <li>Untuk Mengurus Hak Ahli Waris</li>
            <li>Dan lain-lain</li>
        </ul>
        <br>
        <h6>SYARAT PEMBUATAN AKTA KELAHIRAN</h6>
        <p>Syarat-syarat yang harus dipenuhi dalam Permohonan Pembuatan Akta Kelahiran Baru:</p>
        <ol>
            <li>Foto copy Akta Nikah (bagi orang tua yang sudah bercerai dengan menggunakan Akta Cerai) yang telah dilegalisir KUA *apabila tidak bisa memberikan Surat Akta Nikah atau Itsbat maka Anak Merupakan Anak Ibu</li>
            <li>Untuk anak yang tidak diketahui asal usulnya persyaratan pembuatan akta harus dilengkapi dengan Surat Keterangan dari Kepolisian (menjelaskan asal usul anak) dan dokter (menjelaskan perkiraan usia anak)</li>
            <li>Foto copy Kartu Keluarga yang dilegalisir</li>
            <li>Foto copy KTP Ayah dan Ibu, jika usia diatas 17 tahun menggunakan KTP Sendiri</li>
            <li>2 Orang Saksi Pencatatan Pelaporan Kelahiran berikut foto copy KTP yang Masih Berlaku </li>
            <li>Surat Keterangan Lahir dari Kepala Desa / Lurah, Dokter, Bidan, Rumah Sakit yang disahkan di desa / kelurahan</li>
            <li>Surat Kuasa Bermaterai Rp 10.000,- apabila pencatatan dikuasakan</li>
            <li>Mengisi Formulir Permohonan Pencatatan Kelahiran bermaterai Rp 10.000,-</li>
        </ol>
    </div>
    <br>
